...
// podctl注入依赖和修改返回数据格式，k8sservice初始化helper方法
...
func NewHelper() *PageHelper {
	return &PageHelper{}
}

// 字符串转int
func (*PageHelper) StrToInt(str string, def int) int {
...
// 分页 资源
func (*PageHelper) PageResource(current, size int, list []interface{}) *ItemsPage {
	total := len(list)
